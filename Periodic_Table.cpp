...
int main()
{
    ...
    system("COLOR 0E");
    cout<<"\n\n\n\n\n\n\n\n\n\n\n\t\tCHEMISTRY BEYOND BORDERS 2022: BY MICHAEL JAMES";
    Sleep(3000);
    system("cls");
    for(i=1;i<=100;++i)
    {
...
strcpy(elem[114].origin,"IUPAC systematic element name");
    ...
    Sleep(800);
    cout<<"\t\t\tEnter your option then press ENTER: ";
    cin>>t;
    system("cls");
    if(t==1)
    {
    ...
    switch(n)
    {
              ...
              case 2: cout<<"\t   Enter the element name given by the following format: "<<"\n\n";
                      cout<<"\t   (Begin with capital letters and space after the hyphen e.g Sodium- Na) "<<"\n\n";
                      ...
                      cout<<"\t   (Remember: Use this format: Sodium- Na) "<<"\n\n";
                      cout<<"\t\t   \"Element Name\"- \"Element Symbol\""<<"\n\n";
                      cout<<"\t\t   ";
                      goto two;
                      break;
